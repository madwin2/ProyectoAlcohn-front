...
app = FastAPI(title="Detector de Sellos API - Minimal")
...
def health():
    return {
        ...
        "message": "API funcionando con versión minimal"
    }
    ...
    try:
        ...
        for foto in fotos:
            ...
            try:
                ...
                for svg in svgs:
                    try:
                        # Leer SVG como texto y convertir a imagen
                        svg_content = svg.file.read()
                        svg.file.seek(0)  # Resetear posición del archivo
                        
                        # Crear una imagen simple basada en el contenido del SVG
        ...
        return {
            "success": True,
            "message": "Análisis completado con versión minimal",
            "results": resultados
        }
