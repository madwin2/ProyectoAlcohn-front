@echo off
title Procesando Pedido - Aspire Automatico (Maquina G)
color 0A
echo ==========================================
...
REM Buscar el archivo .lua para máquina G
set "LUA_SCRIPT="
for %%f in ("%CURRENT_DIR%AUTOMATIZACION_CON_CAPAS.lua") do set "LUA_SCRIPT=%%f"

if "%LUA_SCRIPT%"=="" (
    echo ERROR: No se encontro el script para maquina G
...
set "TEMP_LUA=%TEMP%\AUTOMATIZACION_G_TEMP.lua"
...
echo Ejecutando automatizacion para MAQUINA G...
...
echo.
echo ==========================================
echo    INFORMACION DE LA MAQUINA G
echo ==========================================
echo.
echo Coordenadas optimizadas para Maquina G:
echo - Columna 36.5mm en X = 50.65
echo - Columna 12mm en X = 94.4
echo - Otras columnas mantenidas igual
echo.
